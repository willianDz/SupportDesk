...
namespace SupportDesk.Persistence.Migrations
{
    ...
    [Migration("20240823231253_AddReviewerUserCommentsToRequest")]
    partial class AddReviewerUserCommentsToRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.Gender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GenderId = 1,
                            Abbreviation = "M",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 581, DateTimeKind.Utc).AddTicks(1356),
                        ...
                        new
                        {
                            GenderId = 2,
                            Abbreviation = "F",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 581, DateTimeKind.Utc).AddTicks(1363),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.RequestType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RequestTypeId = 1,
                            Abbreviation = "TI",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 583, DateTimeKind.Utc).AddTicks(6059),
                        ...
                        new
                        {
                            RequestTypeId = 2,
                            Abbreviation = "RRHH",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 583, DateTimeKind.Utc).AddTicks(6065),
                        ...
                        new
                        {
                            RequestTypeId = 3,
                            Abbreviation = "LEGA",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 583, DateTimeKind.Utc).AddTicks(6067),
                            Description = "Legal",
                            IsActive = true
                        },
                        new
                        {
                            RequestTypeId = 4,
                            Abbreviation = "MANT",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 583, DateTimeKind.Utc).AddTicks(6068),
                        ...
                        new
                        {
                            RequestTypeId = 5,
                            Abbreviation = "MKT",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 583, DateTimeKind.Utc).AddTicks(6069),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("35de8636-18b8-49c4-bbfb-728e543be598"),
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 584, DateTimeKind.Utc).AddTicks(5177),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.Zone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ZoneId = 1,
                            Abbreviation = "ZN",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 584, DateTimeKind.Utc).AddTicks(9887),
                        ...
                        new
                        {
                            ZoneId = 2,
                            Abbreviation = "ZS",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 584, DateTimeKind.Utc).AddTicks(9896),
                        ...
                        new
                        {
                            ZoneId = 3,
                            Abbreviation = "ZC",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 584, DateTimeKind.Utc).AddTicks(9898),
                        ...
                        new
                        {
                            ZoneId = 4,
                            Abbreviation = "ZO",
                            CreatedDate = new DateTime(2024, 8, 23, 23, 12, 52, 584, DateTimeKind.Utc).AddTicks(9915),
