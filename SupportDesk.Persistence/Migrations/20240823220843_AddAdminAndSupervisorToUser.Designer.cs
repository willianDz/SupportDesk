...
namespace SupportDesk.Persistence.Migrations
{
    ...
    [Migration("20240823220843_AddAdminAndSupervisorToUser")]
    partial class AddAdminAndSupervisorToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.Gender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GenderId = 1,
                            Abbreviation = "M",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 606, DateTimeKind.Utc).AddTicks(4227),
                        ...
                        new
                        {
                            GenderId = 2,
                            Abbreviation = "F",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 606, DateTimeKind.Utc).AddTicks(4229),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.RequestType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RequestTypeId = 1,
                            Abbreviation = "TI",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 609, DateTimeKind.Utc).AddTicks(1593),
                        ...
                        new
                        {
                            RequestTypeId = 2,
                            Abbreviation = "RRHH",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 609, DateTimeKind.Utc).AddTicks(1596),
                        ...
                        new
                        {
                            RequestTypeId = 3,
                            Abbreviation = "LEGA",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 609, DateTimeKind.Utc).AddTicks(1597),
                            Description = "Legal",
                            IsActive = true
                        },
                        new
                        {
                            RequestTypeId = 4,
                            Abbreviation = "MANT",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 609, DateTimeKind.Utc).AddTicks(1599),
                        ...
                        new
                        {
                            RequestTypeId = 5,
                            Abbreviation = "MKT",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 609, DateTimeKind.Utc).AddTicks(1600),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("79d60d85-04e7-45c3-9c36-85f62a8d28f3"),
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 610, DateTimeKind.Utc).AddTicks(1573),
            ...
            modelBuilder.Entity("SupportDesk.Domain.Entities.Zone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ZoneId = 1,
                            Abbreviation = "ZN",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 610, DateTimeKind.Utc).AddTicks(7238),
                        ...
                        new
                        {
                            ZoneId = 2,
                            Abbreviation = "ZS",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 610, DateTimeKind.Utc).AddTicks(7246),
                        ...
                        new
                        {
                            ZoneId = 3,
                            Abbreviation = "ZC",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 610, DateTimeKind.Utc).AddTicks(7247),
                        ...
                        new
                        {
                            ZoneId = 4,
                            Abbreviation = "ZO",
                            CreatedDate = new DateTime(2024, 8, 23, 22, 8, 42, 610, DateTimeKind.Utc).AddTicks(7267),
