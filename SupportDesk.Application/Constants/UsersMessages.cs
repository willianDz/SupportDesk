...
public static class UsersMessages
{
    ...
    public const string InvalidFirstName = "Nombres inválidos.";
    ...
    public const string InvalidDateOfBirth = "Fecha de nacimiento inválida.";
    public const string InvalidAge = "No tiene la edad necesaria para utilizar este sistema.";
    public const string InvalidGender = "Género inválido.";
}
